...
import java.util.*;
import mil.army.usace.hec.util.lookup.AbstractLookup.Pair;
...
implements Serializable, AbstractLookup.Storage<Transaction> {
    ...
    public void remove(mil.army.usace.hec.util.lookup.AbstractLookup.Pair item, Transaction transaction) {
    ...
    public mil.army.usace.hec.util.lookup.AbstractLookup.ReferenceToResult cleanUpResult(
        mil.army.usace.hec.util.lookup.Lookup.Template templ
    ) {
    ...
    public mil.army.usace.hec.util.lookup.AbstractLookup.ReferenceToResult registerReferenceToResult(
        mil.army.usace.hec.util.lookup.AbstractLookup.ReferenceToResult newRef
    ) {
