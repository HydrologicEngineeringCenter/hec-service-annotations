...
import java.util.*;
import rma.util.lookup.AbstractLookup.Pair;
...
implements Serializable, AbstractLookup.Storage<Transaction> {
    ...
    public void remove(rma.util.lookup.AbstractLookup.Pair item, Transaction transaction) {
    ...
    public rma.util.lookup.AbstractLookup.ReferenceToResult cleanUpResult(
        rma.util.lookup.Lookup.Template templ
    ) {
    ...
    public rma.util.lookup.AbstractLookup.ReferenceToResult registerReferenceToResult(
        rma.util.lookup.AbstractLookup.ReferenceToResult newRef
    ) {
