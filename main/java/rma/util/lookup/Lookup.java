 ...
 * </UL>
 * <p>
 * @see rma.util.lookup.AbstractLookup
 * @see Lookups
 * @see LookupListener
 * @see LookupEvent
...
public abstract class Lookup implements Serializable
{
     ...
     * default one is based on {@link rma.util.lookup.Lookups#metaInfServices}
    ...
    public static synchronized Lookup getDefault()
    {
        ...
        String className = System.getProperty("rma.util.lookup.Lookup" // NOI18N
        );
        ...
        // have a rma.util.lookup.Lookup line specifying the lookup.
    ...
    private static final class DefLookup extends ProxyLookup
    {
        ...
        public void init(ClassLoader loader, Lookup metaInfLookup, boolean addPath)
        {
            ...
            arr.add(clLookup);
            String paths = System.getProperty("rma.util.lookup.Lookup.paths"); // NOI18N
