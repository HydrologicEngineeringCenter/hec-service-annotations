...
import rma.util.lookup.implspi.NamedServicesProvider;
...
public class Lookups {
     ...
     * all {@link rma.util.lookup.Lookup.Result}s 
     ...
     * that forces a check of the return value of {@link rma.util.lookup.Lookup.Provider#getLookup}</code>.
     *
     ...
     * @param id unique identification of the object, for details see {@link rma.util.lookup.Lookup.Item#getId},
